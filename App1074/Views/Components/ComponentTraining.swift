...
struct MainTrainingScreen: UIViewRepresentable {
    ...
    var type: URLType
    var url: String? = VMF.shared.powerliftingDescription
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        if let savedData = UserDefaults.standard.data(forKey: "SavedTrainingKey"),
    ...
    class Coordinator: NSObject, WKNavigationDelegate {
        var parent: MainTrainingScreen
        var webViewNavigationSubscriber: AnyCancellable? = nil
        
        init(_ webView: MainTrainingScreen) {
            self.parent = webView
        }
